...
public record OrderTrackingResponse(Long orderId, String status, String progressDetails,
    ...
    public static OrderTrackingResponse of(OrderTracking orderTracking) {
        return new OrderTrackingResponse(orderTracking.getOrder().getId(), orderTracking.getStatus().getDescription(),
                orderTracking.getProgressDetails(), orderTracking.getProgressDate());
    }
}
