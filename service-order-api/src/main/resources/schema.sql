CREATE SEQUENCE IF NOT EXISTS client_seq START WITH 3 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS equipment_seq START WITH 3 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS service_order_seq START WITH 2 INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS service_order_tracking_seq START WITH 2 INCREMENT BY 1;
...
CREATE TABLE IF NOT EXISTS service_order_tracking (
    id BIGINT AUTO_INCREMENT PRIMARY KEY,
